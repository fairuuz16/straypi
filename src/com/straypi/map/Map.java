...
import com.straypi.character.Entity;
...
public class Map implements Drawable {
    ...
    public void generateEnemies() {
        for (Point room : rooms) {
            ...
            this.enemies.add(new Enemy(gp, room.x, room.y));
            this.enemies.add(new Enemy(gp, room.x + gp.tileSize, room.y));
            this.enemies.add(new Enemy(gp, room.x - gp.tileSize, room.y));
            this.enemies.add(new Enemy(gp, room.x, room.y + gp.tileSize));
            this.enemies.add(new Enemy(gp, room.x, room.y - gp.tileSize));
        }
    }
